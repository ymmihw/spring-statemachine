...
import com.ymmihw.spring.statemachine.config.ForkJoinStateMachineConfiguration;
...
public class ForkJoinStateMachineIntegrationTest {
  ...
  public void whenForkStateEntered_thenMultipleSubStatesEntered() {
    ...
    assertTrue(
        Arrays.asList("SFork", "Sub1-1", "Sub2-1").containsAll(stateMachine.getState().getIds()));
  }
